...
laplace=cv2.Laplacian(blr3x3,-1)
#kernel=np.array([[-1, -1, -1],[-1,8,-1],[-1,-1,-1]])
#laplace=cv2.filter2D(bw,-1,kernel)
...
cv2.imwrite("blured_9x9_image_ex2.png", blr9x9)
cv2.imwrite("blured_9x9_median_image_ex2.png", blr9x9median)
cv2.imwrite("blured_15x15_median_image_ex2.png", blr15x15median)
cv2.imwrite("laplacian_sharpened_blured_3x3_image_ex2.png", finallap)
